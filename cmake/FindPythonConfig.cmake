...
if(PYTHONINTERP_FOUND)
  ...
  string(CONCAT _Python_config_output ${PYTHON_COMPILE_FLAGS} "; " ${PYTHON_LINK_FLAGS})
  unset(_Python_config)
else(PYTHONINTERP_FOUND)
  message(SEND_ERROR "Python interpreter not found")
endif(PYTHONINTERP_FOUND)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(PythonConfig DEFAULT_MSG _Python_config_output PYTHON_COMPILE_FLAGS PYTHON_LINK_FLAGS)
unset(_Python_config_output)
