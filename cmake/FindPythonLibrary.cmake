...
if(EXISTS "${PYTHON_INCLUDE_PATH}" AND EXISTS "${PYTHON_LIBRARY}" AND EXISTS "${PYTHON_SITE_PACKAGES_DIR}")
  ...
  if(PYTHONINTERP_FOUND)
    ...
    if(python_config)
      ...
      FIND_LIBRARY(PYTHON_LIBRARY NAMES ${PYTHON_LIBRARY_NAMES} HINTS ${PYTHON_INCLUDE_PATH}/../libs)
    ...
    if(APPLE AND NOT _custom_python_fw)
      ...
      if(Python_FRAMEWORKS)
        ...
        if(NOT PYTHON_LIBRARY)
          if(APPLE)
              set (PYTHON_LIBRARY "-F/usr/local/Frameworks -F${HOME}/Library/Frameworks -framework Python" CACHE FILEPATH "Python Framework" FORCE)
          else()
